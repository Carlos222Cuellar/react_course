...
import { registerRequest } from '../actions/index'; //importamos nuestro action para el registro
import '../assets/styles/components/Register.scss';

const Register = (props) => {

  //creando nuestro hook haciendo uso useState va recibir el formulario y el que se va encargar de setiar nuestros datos
  //luego el estado lo inicializamos vacio
